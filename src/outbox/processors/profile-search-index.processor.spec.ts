...
function createProcessor(overrides?: { findFirstResult?: Record<string, unknown> | null }) {
  ...
  const processor = new ProfileSearchIndexProcessor(prisma as never, searchIndex as never);
