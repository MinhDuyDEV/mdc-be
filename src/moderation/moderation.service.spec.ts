...
describe("ModerationService", () => {
  ...
  beforeEach(() => {
    ...
    service = new ModerationService(prisma, outbox, policy as unknown as ModerationPolicyService);
  });
  ...
  describe("createReport", () => {
    it("creates report when target exists", async () => {
      ...
      expect(policy.validateTargetExists).toHaveBeenCalledWith("POST", "post-1");
    });
