...
export class AdminService {
  ...
  // updateUserStatus cyclomatic complexity is inherent to the state-machine
  // transition matrix (validate, short-circuit, audit, refresh-token revoke,
  // outbox emit). All branches have dedicated tests in admin.service.spec.ts.
