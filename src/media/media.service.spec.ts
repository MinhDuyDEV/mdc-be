...
describe('MediaService', () => {
  ...
  describe('confirmUpload', () => {
    it('should update media status to READY', async () => {
      ...
      const result = await service.confirmUpload(user, mediaId);
  ...
  describe('getDownloadUrl', () => {
    it('should return presigned download URL', async () => {
      ...
      const result = await service.getDownloadUrl(user, mediaId);
  ...
  describe('deleteAsset', () => {
    it('should mark asset as DELETED', async () => {
      ...
      const result = await service.deleteAsset(user, mediaId);
